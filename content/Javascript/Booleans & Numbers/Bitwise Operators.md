...
This might seem surprising, but it's because of how negative numbers are represented in binary using [two's complement.](https://en.wikipedia.org/wiki/Two%27s_complement)
